    ...
    <footer className="py-12 px-6" style={{ borderTop: '1px solid #1e1e1e' }}>
      <div className="max-w-6xl mx-auto flex flex-col md:flex-row items-center justify-between gap-6">
        <div className="text-center md:text-left">
          <p className="font-display text-white text-lg">SALON & BOUTIQUE</p>
          <p className="text-sm tracking-widest uppercase" style={{ color: '#C9A84C' }}>DARIO BLANCO</p>
        </div>
        ...
        <div className="flex flex-col items-center md:items-end gap-1">
          <p className="text-gray-600 text-xs text-center md:text-right">
            © {new Date().getFullYear()} Salon &amp; Boutique Darío Blanco. Todos los derechos reservados.
          </p>
